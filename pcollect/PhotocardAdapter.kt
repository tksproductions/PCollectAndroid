...
class PhotocardAdapter(private val photocardList: MutableList<Photocard>) : RecyclerView.Adapter<PhotocardAdapter.PhotocardViewHolder>() {
    ...
    class PhotocardViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(photocard: Photocard) {
            photocardImageView.setImageURI(photocard.imageUri)
        }
    }
